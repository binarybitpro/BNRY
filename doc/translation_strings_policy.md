...
This document provides guidelines for internationalization of the BinaryBit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `binarybit_en.ts` remains unchanged.
