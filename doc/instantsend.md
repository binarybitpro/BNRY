...
This mechanism has been integrated into Bitcore-Node-BinaryBit which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/binarybitpay/insight-api-binarybit#web-socket-api](https://github.com/binarybitpay/insight-api-binarybit#web-socket-api)
* API: [https://github.com/binarybitpay/insight-api-binarybit#instantsend-transactions](https://github.com/binarybitpay/insight-api-binarybit#instantsend-transactions)
