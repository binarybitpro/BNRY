# BinaryBit Core version v19.3.0
...
- `wipetxes`: New command for `binarybit-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/binarybitpro/BNRY/compare/v19.2.0...binarybitpay:v19.3.0).
