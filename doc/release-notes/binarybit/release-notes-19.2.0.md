# BinaryBit Core version v19.2.0
...
At the first startup BinaryBit Core will run a migration process which can take
...
incompatible with older versions of BinaryBit Core, so a db migration path was
...
See detailed [set of changes](https://github.com/binarybitpro/BNRY/compare/v19.1.0...binarybitpay:v19.2.0).
