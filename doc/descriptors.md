# Support for Output Descriptors in BinaryBit Core

Since BinaryBit Core v0.17, there is support for Output Descriptors. This is a
...
existing BinaryBit Core wallets, a convenience function `combo` is
...
All RPCs in BinaryBit Core will include the checksum in their output. Only
