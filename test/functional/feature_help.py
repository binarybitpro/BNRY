...
"""Verify that starting binarybitd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start binarybitd with -h for help text")
        ...
        self.log.info("Start binarybitd with -version for version information")
        ...
        self.log.info("Start binarybitdd with -fakearg to make sure it does not start")
