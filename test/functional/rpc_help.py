...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: BinaryBit's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'BinaryBit', 'Evo', 'Generating', 'Mining', 'Network', 'Rawtransactions', 'Util']
