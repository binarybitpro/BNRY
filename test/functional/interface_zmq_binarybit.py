...
"""Test the binarybit specific ZMQ notification interfaces."""
...
from test_framework.test_framework import BinaryBitTestFramework
...
class BinaryBitZMQTest (BinaryBitTestFramework):
    def set_test_params(self):
        ...
        self.set_binarybit_test_params(5, 4, fast_dip3_enforcement=True, extra_args=extra_args)
        self.set_binarybit_llmq_test_params(4, 4)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that binarybitd has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all binarybit related ZMQ publisher
