Contributing to BinaryBit Core
============================

The BinaryBit Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/binarybitpro/BNRY/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.
...
include:
  ...
  - *qt* for changes to binarybit-qt
...
[Translation Process](https://github.com/binarybitpro/BNRY/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BinaryBit Core project (and related
projects such as libsecp256k1), and is not to be confused with overall BinaryBit
Network Protocol consensus changes.

Whether a pull request is merged into BinaryBit Core rests with the project merge
...
Patches that change BinaryBit consensus rules are considerably more involved than
...
Where a patch set proposes to change the BinaryBit consensus, it must have been
...
The review process is normally fairly responsive on the BinaryBit Core repository, however
...
Bitcoin Backports are an incredibly valuable part of BinaryBit's development. Backporting allows us to easily implement new
features, improvements and fixes as bitcoin implements them.

To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for BinaryBit](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).
...
The project leader is the release manager for each BinaryBit Core release.
