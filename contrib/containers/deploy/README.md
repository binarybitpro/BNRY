...
official/supported Docker Images found at https://hub.docker.com/r/binarybitpay/binarybitd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/binarybitpay/binarybitd-develop/ when changing the above text**