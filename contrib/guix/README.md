# Bootstrappable BinaryBit Core Builds

This directory contains the files necessary to perform bootstrappable BinaryBit
Core builds.
...
To build BinaryBit Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      BinaryBit Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/binarybit-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/binarybitpay/guix.sigs).
...
[guix-docker]: https://github.com/binarybitpro/BNRY/tree/master/contrib/guix/Dockerfile
