...
EXPECTED_HOLDER_NAMES = [
    ...
    r"The BinaryBit Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a BinaryBit Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BinaryBit Core developers'
...
Arguments:
    <base_directory> - The base directory of BinaryBit Core source code repository.
"""
...
Arguments:
    <file> - A source file in the BinaryBit Core repository.
"""
