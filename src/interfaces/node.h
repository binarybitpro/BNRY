...
//! Interface for the src/evo part of a binarybit node (binarybitd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a binarybit node (binarybitd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a binarybit node (binarybitd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a binarybit node (binarybitd process).
...
//! Top-level interface for a binarybit node (binarybitd process).
class Node
{
public:
    virtual ~Node() {}
