...
/** Utility functions used by the BinaryBit Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "binarybit:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load binarybit specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a binarybit specific theme is activated (light/dark).*/
