...
;(function() {
  ...
  function runInContext(context) {
    // Exit early if unable to acquire lobinarybit.
    var _ = context && context._ || require('lobinarybit') || root._;
    if (!_) {
     ...
     *
     * Note: The Benchmark constructor exposes a handful of lobinarybit methods to
     * make working with arrays, collections, and objects easier. The lobinarybit
     * methods are:
     * [`each/forEach`](https://lobinarybit.com/docs#forEach), [`forOwn`](https://lobinarybit.com/docs#forOwn),
     * [`has`](https://lobinarybit.com/docs#has), [`indexOf`](https://lobinarybit.com/docs#indexOf),
     * [`map`](https://lobinarybit.com/docs#map), and [`reduce`](https://lobinarybit.com/docs#reduce)
     *
     * @constructor
     ...
     *
     * Note: Each Suite instance has a handful of wrapped lobinarybit methods to
     * make working with Suites easier. The wrapped lobinarybit methods are:
     * [`each/forEach`](https://lobinarybit.com/docs#forEach), [`indexOf`](https://lobinarybit.com/docs#indexOf),
     * [`map`](https://lobinarybit.com/docs#map), and [`reduce`](https://lobinarybit.com/docs#reduce)
     *
     * @constructor
     * @memberOf Benchmark
    ...
    // Add lobinarybit methods to Benchmark.
    ...
    // Add lobinarybit methods as Suite methods.
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    define(['lobinarybit', 'platform'], function(_, platform) {
      return runInContext({
        '_': _,
        'platform': platform
      });
