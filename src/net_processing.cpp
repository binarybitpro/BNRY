 ...
 *  We have 4 times smaller block times in BinaryBit, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        BinaryBit Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // BNRY this code also handles non-TXs (BinaryBit specific messages)
