...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"binarybit\" activates all BinaryBit-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "binarybit")
    + HelpExampleRpc("debug", "binarybit+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The binarybit address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The binarybit address to use for the signature."},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The difference of Binar"},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The number of Binar of the output"},
...
static UniValue getaddressbalance(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressbalance",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::NUM, "balance", "The current total balance in Binar"},
                    {RPCResult::Type::NUM, "balance_immature", "The current immature balance in Binar"},
                    {RPCResult::Type::NUM, "balance_spendable", "The current spendable balance in Binar"},
                    {RPCResult::Type::NUM, "received", "The total number of Binar received (including change)"},
                }},
        RPCExamples{
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "binarybit-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* BinaryBit features */
    { "binarybit",               "mnsync",                 &mnsync,                 {} },
    { "binarybit",               "spork",                  &spork,                  {"command"} },
    { "binarybit",               "sporkupdate",            &sporkupdate,            {"name","value"} },
