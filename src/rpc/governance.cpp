...
static UniValue gobject_prepare(const JSONRPCRequest& request)
{
    ...
    // This command is dangerous because it consumes 5 BNRY irreversibly.
    // If params are lost, it's very hard to bruteforce them and yet
    // users ignore all instructions on binarybitcentral etc. and do not save them...
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    /* BinaryBit features */
    { "binarybit",               "getgovernanceinfo",      &getgovernanceinfo,      {} },
    { "binarybit",               "getsuperblockbudget",    &getsuperblockbudget,    {"index"} },
    { "binarybit",               "gobject",                &gobject,                {} },
    { "binarybit",               "voteraw",                &voteraw,                {"tx_hash","tx_index","gov_hash","signal","outcome","time","sig"} },
