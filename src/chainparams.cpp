 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1707199522, nBits=1e0ffff0, nNonce=1342766, vtx=1)
...
{
    const char* pszTimestamp = " I believe that people make their own luck by great preparation and";
    const CScript genesisOutputScript = CScript() << ParseHex("04bb2c608eeeb83bde22de6b88d84c837265434b83bcd384dede9c5610e0c41d13d38b6bd3ef792bdb192d6fc5c1b423dbe7a36e2e180ee51fe8847f805c6de799") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x0000030943932a5694ab9a6730e5bcdf293d34e3111d33e91bcecb3266b017db"); 
        ...
        genesis = CreateGenesisBlock(1707199522, 1342766, 0x1e0ffff0, 1, 15 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000030943932a5694ab9a6730e5bcdf293d34e3111d33e91bcecb3266b017db"));
        assert(genesis.hashMerkleRoot == uint256S("0x82170fefe0d3751699ae2c59e05f14ab40c3bc90b86d66346b0d7c64cdc50881"));
        ...
        vSeeds.emplace_back("168.119.255.248");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,25);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,26);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,153);
        // BinaryBit BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // BinaryBit BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // BinaryBit BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"B4pskNTD3fnC14yhhoQqVKe25if8LdpAKD"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x0000030943932a5694ab9a6730e5bcdf293d34e3111d33e91bcecb3266b017db")},
            }
        };
        ...
        // getchaintxstats 17280 0000030943932a5694ab9a6730e5bcdf293d34e3111d33e91bcecb3266b017db
        chainTxData = ChainTxData{
                1707199522, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000942cb14189e5888451771e10420e0c7176fc4ebd0a7a07fd96106c7583c"); 
        ...
        genesis = CreateGenesisBlock(1707199527UL, 358755UL, 0x1e0ffff0, 1, 15 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000942cb14189e5888451771e10420e0c7176fc4ebd0a7a07fd96106c7583c"));
        assert(genesis.hashMerkleRoot == uint256S("0x82170fefe0d3751699ae2c59e05f14ab40c3bc90b86d66346b0d7c64cdc50881"));
        ...
        // Testnet BinaryBit BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet BinaryBit BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet BinaryBit BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"YSuBAEbs65FMXSkh2Z5h6iuYW7m8sbv4NR"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x00000942cb14189e5888451771e10420e0c7176fc4ebd0a7a07fd96106c7583c")},
            }
        };
        ...
        // getchaintxstats 17280 00000942cb14189e5888451771e10420e0c7176fc4ebd0a7a07fd96106c7583c
        chainTxData = ChainTxData{
                1707199527, // * UNIX timestamp of last known number of transactions
                0,    // * total number of transactions between genesis and that timestamp
                            //   (the tx=... number in the ChainStateFlushed debug.log lines)
                0,       // * estimated number of transactions per second after that timestamp
        };
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1707199532, 0, 0x207fffff, 1, 15 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x47a89d979358a5dee2f2d8844573ca5684c7ada1d4baa171a26cf22dfaccf84b"));
        assert(genesis.hashMerkleRoot == uint256S("0x82170fefe0d3751699ae2c59e05f14ab40c3bc90b86d66346b0d7c64cdc50881"));

        devnetGenesis = FindDevNetGenesisBlock(genesis, 15 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x47a89d979358a5dee2f2d8844573ca5684c7ada1d4baa171a26cf22dfaccf84b")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // privKey: 7vNcpjDkBsgCsTsTyDUmkNxdGpqCZ7EiHwbvrCpn6iGfYyJYjh1
        vSporkAddresses = {"YVsCBFysadAhm6WGT7pWVD4ZZGGLNYHBFF"};
        nMinSporkKeys = 1;
        ...
        // Regtest BinaryBit addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,78);
        // Regtest BinaryBit script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,79);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,206);
        // Regtest BinaryBit BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest BinaryBit BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest BinaryBit BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
