...
/* Initialize BinaryBit-specific components after chainstate initialization */
void BinaryBitTestSetup(NodeContext& node);
void BinaryBitTestSetupClose(NodeContext& node);
